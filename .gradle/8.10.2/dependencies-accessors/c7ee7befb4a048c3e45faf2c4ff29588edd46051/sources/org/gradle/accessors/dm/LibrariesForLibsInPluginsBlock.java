...
public class LibrariesForLibsInPluginsBlock extends AbstractExternalDependencyFactory {
    ...
    private final GeofireLibraryAccessors laccForGeofireLibraryAccessors = new GeofireLibraryAccessors(owner);
    private final GeohashLibraryAccessors laccForGeohashLibraryAccessors = new GeohashLibraryAccessors(owner);
    private final GoogleLibraryAccessors laccForGoogleLibraryAccessors = new GoogleLibraryAccessors(owner);
    private final InputLibraryAccessors laccForInputLibraryAccessors = new InputLibraryAccessors(owner);
    ...
    /**
     * Dependency provider for <b>maplibre</b> with <b>org.maplibre.gl:android-sdk</b> coordinates and
     * with version reference <b>maplibreAndroidSdk</b>
     * <p>
     * This dependency was declared in catalog libs.versions.toml
     *
     * @deprecated Will be removed in Gradle 9.0.
     */
    @Deprecated
    public Provider<MinimalExternalModuleDependency> getMaplibre() {
        org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
        return create("maplibre");
    }
    ...
    /**
     * Group of libraries at <b>geofire</b>
     *
     * @deprecated Will be removed in Gradle 9.0.
     */
    @Deprecated
    public GeofireLibraryAccessors getGeofire() {
        org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
        return laccForGeofireLibraryAccessors;
    }

    /**
     * Group of libraries at <b>geohash</b>
     *
     * @deprecated Will be removed in Gradle 9.0.
     */
    @Deprecated
    public GeohashLibraryAccessors getGeohash() {
        org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
        return laccForGeohashLibraryAccessors;
    }
    ...
    /**
     * Group of libraries at <b>input</b>
     *
     * @deprecated Will be removed in Gradle 9.0.
     */
    @Deprecated
    public InputLibraryAccessors getInput() {
        org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
        return laccForInputLibraryAccessors;
    }
    ...
    public static class AndroidLibraryAccessors extends SubDependencyFactory {
        private final AndroidPluginLibraryAccessors laccForAndroidPluginLibraryAccessors = new AndroidPluginLibraryAccessors(owner);

        public AndroidLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Group of libraries at <b>android.plugin</b>
         *
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
        public AndroidPluginLibraryAccessors getPlugin() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return laccForAndroidPluginLibraryAccessors;
        }
     ...
     */
    @Deprecated
    public static class AndroidPluginLibraryAccessors extends SubDependencyFactory {

        public AndroidPluginLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>annotation</b> with <b>org.maplibre.gl:android-plugin-annotation</b> coordinates and
         * with version reference <b>androidPluginAnnotation</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
        ...
        public Provider<MinimalExternalModuleDependency> getAnnotation() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("android.plugin.annotation");
        }
    ...
    public static class AndroidxNavigationFragmentKtxLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {
        ...
        /**
         * Dependency provider for <b>v276</b> with <b>androidx.navigation:navigation-fragment-ktx</b> coordinates and
        ...
        public Provider<MinimalExternalModuleDependency> getV276() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("androidx.navigation.fragment.ktx.v276");
        }
     ...
     */
    @Deprecated
    public static class GeofireLibraryAccessors extends SubDependencyFactory {
        private final GeofireAndroidLibraryAccessors laccForGeofireAndroidLibraryAccessors = new GeofireAndroidLibraryAccessors(owner);

        public GeofireLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Group of libraries at <b>geofire.android</b>
         *
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
        public GeofireAndroidLibraryAccessors getAndroid() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return laccForGeofireAndroidLibraryAccessors;
        }
     ...
     */
    @Deprecated
    public static class GeofireAndroidLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {

        public GeofireAndroidLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>android</b> with <b>com.github.firebase:geofire-android</b> coordinates and
         * with version reference <b>geofireAndroid</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
        ...
        public Provider<MinimalExternalModuleDependency> asProvider() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("geofire.android");
        }

        /**
         * Dependency provider for <b>common</b> with <b>com.firebase:geofire-android-common</b> coordinates and
         * with version reference <b>geofireAndroidCommon</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
        ...
        public Provider<MinimalExternalModuleDependency> getCommon() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("geofire.android.common");
        }
     ...
     */
    @Deprecated
    public static class GeohashLibraryAccessors extends SubDependencyFactory {

        public GeohashLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>kt</b> with <b>com.github.chrisbanes:geohash-kt</b> coordinates and
         * with version reference <b>geohashKt</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
     ...
     */
    @Deprecated
    public static class InputLibraryAccessors extends SubDependencyFactory {
        private final InputMaskLibraryAccessors laccForInputMaskLibraryAccessors = new InputMaskLibraryAccessors(owner);

        public InputLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Group of libraries at <b>input.mask</b>
         *
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
        public InputMaskLibraryAccessors getMask() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return laccForInputMaskLibraryAccessors;
        }
     ...
     */
    @Deprecated
    public static class InputMaskLibraryAccessors extends SubDependencyFactory {

        public InputMaskLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>android</b> with <b>com.redmadrobot:input-mask-android</b> coordinates and
         * with version reference <b>inputMaskAndroid</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
        ...
        public Provider<MinimalExternalModuleDependency> getAndroid() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("input.mask.android");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>androidPluginAnnotation</b> with value <b>2.0.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getAndroidPluginAnnotation() { return getVersion("androidPluginAnnotation"); }
        ...
        /**
         * Version alias <b>cloudinaryAndroid</b> with value <b>3.0.2</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>geofireAndroid</b> with value <b>3.1.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getGeofireAndroid() { return getVersion("geofireAndroid"); }

        /**
         * Version alias <b>geofireAndroidCommon</b> with value <b>3.2.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getGeofireAndroidCommon() { return getVersion("geofireAndroidCommon"); }

        /**
         * Version alias <b>geohashKt</b> with value <b>1.1.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getGeohashKt() { return getVersion("geohashKt"); }
        ...
        /**
         * Version alias <b>inputMaskAndroid</b> with value <b>6.1.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getInputMaskAndroid() { return getVersion("inputMaskAndroid"); }
        ...
        /**
         * Version alias <b>maplibreAndroidSdk</b> with value <b>11.8.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getMaplibreAndroidSdk() { return getVersion("maplibreAndroidSdk"); }
        ...
        /**
         * Version alias <b>materialIconsCore</b> with value <b>1.5.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>navigationFragmentKtxVersion</b> with value <b>2.8.9</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>navigationSafeArgsGradlePlugin</b> with value <b>2.8.9</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
