...
public class LibrariesForLibsInPluginsBlock extends AbstractExternalDependencyFactory {
    ...
    public static class AndroidPluginAnnotationLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Dependency provider for <b>v9</b> with <b>org.maplibre.gl:android-plugin-annotation-v9</b> coordinates and
         * with version reference <b>androidPluginAnnotationV9</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
        ...
        public Provider<MinimalExternalModuleDependency> getV9() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("android.plugin.annotation.v9");
        }
     ...
     */
    @Deprecated
    public static class MapboxLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {

        public MapboxLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>mapbox</b> with <b>com.mapbox.mapboxsdk:mapbox-android-sdk</b> coordinates and
         * with version reference <b>mapboxSdk</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
        ...
        /**
         * Dependency provider for <b>annotation</b> with <b>com.mapbox.mapboxsdk:mapbox-android-plugin-annotation-v9</b> coordinates and
         * with version reference <b>mapboxAnnotation</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
        ...
        public Provider<MinimalExternalModuleDependency> getAnnotation() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("mapbox.annotation");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>androidPluginAnnotationV9</b> with value <b>0.9.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getAndroidPluginAnnotationV9() { return getVersion("androidPluginAnnotationV9"); }
        ...
        /**
         * Version alias <b>mapboxAnnotation</b> with value <b>0.9.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getMapboxAnnotation() { return getVersion("mapboxAnnotation"); }

        /**
         * Version alias <b>mapboxSdk</b> with value <b>9.6.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getMapboxSdk() { return getVersion("mapboxSdk"); }
